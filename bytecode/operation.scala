...
object Operation {
    def deserialize(owner: MethodInfo, input: DataInputStream): Operation = {
        ...
        var operation: Operation = opCode match {
            ...
            case 9 => throw new Exception("TODO")
            case 10 => throw new Exception("TODO")
            case 11 => throw new Exception("TODO")
            case 12 => throw new Exception("TODO")
            case 13 => throw new Exception("TODO")
            case 14 => throw new Exception("TODO")
            case 15 => throw new Exception("TODO")
