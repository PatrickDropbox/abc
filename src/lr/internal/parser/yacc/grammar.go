...
var LrAct = [...]int{
	19, 20, 17, 32, 21, 14, 13, 26, 15, 29,
	15, 15, 25, 16, 23, 24, 12, 27, 30, 21,
	7, 8, 5, 3, 28, 9, 11, 1, 10, 31,
	22, 33, 18, 6, 2, 4,
}

var LrPact = [...]int{
	16, -1000, 16, 2, -5, -3, -1000, -1000, -1000, -6,
	-1, 1, -1000, -4, -9, -1000, -1000, -1000, 4, -9,
	-1000, -8, -1000, -7, -1000, 6, -1000, 9, -1000, -14,
	-8, -1000, -1000, -9,
}
...
//line grammar.y:125
		{
			LrVAL.Definition, _ = Lrlex.(*ParseContext).StartDeclToDef(LrDollar[1].Generic_, LrDollar[2].Token)
		}
	case 12:
		LrDollar = LrS[Lrpt-1 : Lrpt+1]
//line grammar.y:128
