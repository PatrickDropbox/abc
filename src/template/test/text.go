...
func (TextTemplate) Name() string { return "TextTemplate" }

func (template *TextTemplate) writeValue(
...
func (_template *TextTemplate) WriteTo(_output io.Writer) (int64, error) {
	_numWritten := int64(0)
